...
def RunPindel(args, wd, vcfoutName, tag):
    ...
    if(tag):
        ...
        if(args.qsub):
            ...
            cl_cmd = args.bsub + " -q " + args.queue + " -J " + "Pindel_" + args.patientId + "_" + str(myPid) + " -o " + "Pindel_" + args.patientId + "_" + str(myPid) + ".stdout" + " -e " + "Pindel_" + args.patientId + "_" + str(myPid) + ".stderr" + " -We 48:00 -R \"rusage[mem=" + str(mem) + "]\" -M " + str(maxmem) + " -n " + args.threads + " -cwd " + wd + " -K " + cmd 
    ...
    if(retcode >= 0):
        ...
        if(os.path.isfile(vcfOutPath)):
            ...
            if(args.qsub):
                ...
                p2v_cl = args.bsub + " -q " + args.queue + " -J " + "Pindel2Vcf_" + args.patientId + "_" + str(myPid) + " -o " + "Pindel2Vcf_" + args.patientId + "_" + str(myPid) + ".stdout" + " -e " + "Pindel2Vcf_" + args.patientId + "_" + str(myPid) + ".stderr" +  " -We 48:00 -R \"rusage[mem=8]\" -M 16 -n 1" + " -cwd " + wd + " -K " + p2v_cmd 
